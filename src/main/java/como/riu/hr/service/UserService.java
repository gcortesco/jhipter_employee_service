package como.riu.hr.service;

import como.riu.hr.config.Constants;
import como.riu.hr.domain.Authority;
import como.riu.hr.domain.User;
import como.riu.hr.repository.AuthorityRepository;
import como.riu.hr.repository.UserRepository;
import como.riu.hr.security.SecurityUtils;
import como.riu.hr.service.dto.AdminUserDTO;
...
public class UserService {
     ...
     */
    public User updateUser(String id, String firstName, String lastName, String email, String langKey, String imageUrl) {

           User user = userRepository.findOneById(id).stream().findFirst().orElse(null);
        ...
        if (existingUser.isPresent()) {
            ...
            if (details.get("updated_at") != null) {
                ...
                if (idpModifiedDate.isAfter(dbModifiedDate)) {
                    ...
                    updateUser(null,user.getFirstName(), user.getLastName(), user.getEmail(), user.getLangKey(), user.getImageUrl());
                }
